...
public class Database {
    ...
    private static void loadConnection() {
        try {
            connection = DriverManager.getConnection(getFormateURL(), USER, PASSWORD);
        }
        catch (SQLException e) {
            errorHandler("Failed to connect to the database " + getFormateURL(), e);
        }
    }
    ...
    public static String getFormateURL() {
